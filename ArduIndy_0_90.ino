...
void DisplayMainMenu()
{
  ...
  {
    // nothing, because this is the combination for pausing the game!
  }
...
void DisplayPausedGame()
{
  ...
  if (debugInfo)
  {
    arduboy.setCursor(103, 27);
    arduboy.print("X=" + String(roomX));

    arduboy.setCursor(103, 40);
    arduboy.print("Y=" + String(roomY));
  }
...
void GhostHit(byte killedGhostNo)
{
  ...
  killCounter++;
  if (killCounter == NO_KILLS_GIVE_LIVE)
  {
    killCounter = 0;
    lives++;
  }
